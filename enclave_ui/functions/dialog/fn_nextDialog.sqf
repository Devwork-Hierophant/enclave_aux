...
profileNamespace setVariable [("enclave_character_info_" + str _character), [_name, _age, _faction, _background]];
...
["enclave_character_skills", _unit] call enclave_fnc_openDialog;

// [_unit, _dialog, true] spawn enclave_fnc_changeDialog;