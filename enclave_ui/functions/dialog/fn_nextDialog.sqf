...
private _v1 = format[["SELECT charNum FROM characterinfo WHERE cid=%1 ORDER BY charNum DESC;",getPlayerUID player]] call enclave_db_fnc_callExtDB3;

//TODO: SEE WHAT V1 IS AND MAKE THE CHARNUM BE WHAT IT NEEDS TO BE.... FML

private _cid = format[["SELECT cid FROM playerinfo WHERE sid=%1",getPlayerUID player]] call enclave_db_fnc_callExtDB3;
